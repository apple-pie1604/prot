...
requirements = python3,kivy==2.3.0,https://github.com/kivymd/KivyMD/archive/master.zip, pillow,plyer,pyjnius,asyncio
...
#android.permissions = android.permission.INTERNET, android.permissions.VIBRATE (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18)
...
# (list) The Android archs to build for, choices: arm64-v8a, x86, x86_64
